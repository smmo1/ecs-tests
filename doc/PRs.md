Original: https://github.com/ecaresoft/ecs-dev-guidelines/wiki/Pull-Requests
...
Example:
```
Refactor de componentes + tests de person/people.

* Se removió el modal de people.new/person.edit en favor de una ruta
* Se movió todo a la estructura de pods.
* Person/People ahora esta en componentes.
```
